...
$pageTitle = $Department_List_ ?? 'Department List';
if (!is_loggedin()) {
?><script>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a data-id="<?= $row->id ?>" class="btn btn-sm btn-info btn-primary" data-toggle="modal" data-target="#modal-default"><?= $Edit_ ?? 'Edit' ?></a>
                                                <!-- |
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><?= $Update_Department_ ?? 'Department Update' ?></h4>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                <label for="dept_name"><?= $Department_Name_ ?? 'Department Name' ?></label>
            ...
            <div class="modal-footer justify-content-between">
                <button type="button" class="btn btn-default" data-dismiss="modal"><?=$Close_??'Close'?></button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
